...
/*
 *  * Challenge 3: toString helper
 *   *
 *    * Called when one operand of + is a string and the other is not.
 *     * Converts the non-string value to its string representation,
 *      * then concatenates.  This implements JavaScript/Python-style
 *       * implicit coercion for the + operator.
 *        */
																	       ...
																	       case OP_EQUAL: { Value b=pop(),a=pop(); push(BOOL_VAL(valuesEqual(a,b))); break; }
																			            case OP_GREATER:  BINARY_OP(BOOL_VAL, >); break;
																						            case OP_LESS:     BINARY_OP(BOOL_VAL, <); break;
																									            case OP_ADD: {
																													         /*
																														  *          * Challenge 3: mixed-type + handling.
																														  *                   *
																														  *                            * If BOTH are strings  → concatenate.
																														  *                                     * If BOTH are numbers  → add numerically.
																														  *                                              * If ONE is a string   → convert the other to string, concatenate.
																														  *                                                       *                        (Our chosen policy — see ANSWERS.md)
																																	               ...
																																	               push(OBJ_VAL(concatString(a, b)));
																																				                 ...
																																				                 double b=AS_NUMBER(pop()), a=AS_NUMBER(pop());
																																						           push(NUMBER_VAL(a+b));
																																									             ...
																																									             /* Mixed: coerce non-string to string */
																																									             Value right = pop();
																																										               Value left  = pop();
