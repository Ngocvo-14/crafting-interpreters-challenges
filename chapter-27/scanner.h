...
typedef enum {
  ...
  TOKEN_LEFT_BRACKET, TOKEN_RIGHT_BRACKET,  /* ch27 challenge 2: obj["field"] */
  ...
  TOKEN_DELETE,  /* ch27 challenge 3: delete obj.field */
  TOKEN_HAS,     /* ch27 challenge 1: has obj.field */
